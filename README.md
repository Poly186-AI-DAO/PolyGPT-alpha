...
[
  {
    ...
    "evidence": "retrieveassistantagent(name='assistant', system_message=\"engineer. you follow an approved plan. you write python/shell code to solve tasks. \\n            wrap the code in a code block that specifies the script type. the user can't modify your code.\\n            so do not suggest incomplete code which requires others to modify. don't use a code block if it's not intended to be executed by the execu"
  }
]
```
